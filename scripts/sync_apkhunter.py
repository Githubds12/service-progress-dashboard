        ...
        for row in reader:
            ...
            def guess_category(name, tid, desc="", sms=""):
                ...
                cat_map = {
                    ...
                    "Music/Audio": ['music', 'radio', 'mp3', 'player', 'song', 'podcast', 'audio', 'sound', 'dj', 'mix', 'equalizer', 'spotify', 'deezer', 'shazam', 'recorder', 'voice', 'sing', 'karaoke', 'instrument', 'guitar', 'piano', 'beat', 'rhythm', 'tune', 'tuner', 'streaming', 'album', 'artist', 'track', 'playlist', 'lyrics', 'tidal', 'soundcloud', 'pandora', 'apple music', 'yt music', 'megogo'],
                    ...
                    "Business/Work": ['meeting', 'zoom', 'office', 'work', 'job', 'recruit', 'business', 'resume', 'teams', 'hr', 'staff', 'employee', 'enterprise', 'crm', 'erp', 'slack', 'outlook', 'mail', 'calendar', 'task', 'project', 'collab', 'management', 'admin', 'hiring', 'interview', 'salary', 'payroll', 'expense', 'inc', 'corp', 'company', 'startup', 'client', 'partner', 'github', 'docusign', 'linkedin', 'xing', 'lark', 'calendly', 'tipalti', 'trello', 'asana', 'monday', 'notion', 'clickup', 'basecamp', 'mailchimp'],
                    "Betting/Gambling": ['bet', 'win', 'casino', 'slot', 'poker', 'gambling', '1win', 'pin-up', 'betpawa', 'betwinner', '888starz', 'megapari', 'winwin', 'linebet', 'melbet', 'mostbet', 'parimatch', 'betway', 'dafabet', '1xbet', 'pinup', 'paripulse', 'premierbet', 'marathon', 'parimatch', 'betfair', 'williamhill', 'bet365', 'draftkings', 'fanduel', 'sporty', '1xslots', 'betssonarcb', 'premierbet', 'marathon'],
