    ...
    <style>
        ...
        * {{ box-sizing: border-box; margin: 0; padding: 0; outline: none; }}
        ...
        body {{ 
            ...
            background-image: 
                url('dashboard/bhairavi_texture.png'),
        ...
        .quote-card {{
            background: url('dashboard/bhairavi_texture.png'); background-size: cover; background-position: center;
...
<body>
    <div class="container">
        ...
        <div class="banner-container">
            <img src="dashboard/bhairavi_banner.png" class="banner-img" alt="Bhairavi">
