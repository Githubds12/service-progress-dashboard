        ...
        for row in reader:
            ...
            def guess_category(name, tid, desc="", sms=""):
                ...
                cat_map = {
                    ...
                    "Photography/Video": ['photo', 'camera', 'editor', 'gallery', 'video', 'clip', 'collage', 'beauty', 'filter', 'lens', 'selfie', 'retouch', 'frame', 'album', 'shot', 'capture', 'movie', 'cinema', 'player', 'vlc', 'netflix', 'youtube', 'prime', 'hulu', 'disney', 'tv', 'show', 'ott', 'vlog', 'reels', 'cinema', 'theatre', 'broadcasting', 'production', 'vlc', 'mx player', 'kmplayer', 'plex', 'kodi', 'megogo', 'max'],
