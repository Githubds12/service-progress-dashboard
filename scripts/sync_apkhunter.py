        ...
        for row in reader:
            ...
            def guess_category(name, tid, desc=""):
                ...
                cat_map = {
                    ...
                    "Social/Media": ['chat', 'social', 'meet', 'date', 'talk', 'message', 'video', 'stream', 'live', 'fan', 'social', 'post', 'status', 'follow', 'messenger', 'viber', 'telegram', 'whatsapp', 'signal', 'wechat', 'tinder', 'bumble', 'discord', 'reels', 'tiktok', 'snapchat', 'insta', 'tweet', 'blog', 'forum', 'socail', 'network', 'profile', 'story', 'reel', 'vlog', 'community', 'club', 'celebrity', 'influencer', 'emoji', 'sticker', 'gif', 'talk', 'voip'],
                    "Lifestyle/Travel": ['delivery', 'food', 'eat', 'order', 'taxi', 'ride', 'travel', 'trip', 'hotel', 'flight', 'booking', 'bus', 'train', 'airline', 'resort', 'vacation', 'uber', 'grab', 'bolt', 'foodpanda', 'zomato', 'swiggy', 'doordash', 'deliveroo', 'map', 'tourism', 'guide', 'passport', 'visa', 'rent', 'lease', 'home', 'house', 'room', 'apartment', 'flat', 'stay', 'car', 'auto', 'vehicle', 'parking', 'fuel', 'gas', 'electric', 'weather', 'news'],
                    "Gaming/Entertainment": ['game', 'play', 'fun', 'poker', 'casino', 'bet', 'slot', 'puzzle', 'action', 'rpg', 'mmo', 'strategy', 'arcade', 'simulator', 'quest', 'win', 'prize', 'spin', 'card', 'board', 'adventure', 'craft', 'battle', 'strike', 'combat', 'war', 'hero', 'legend', 'quest', 'gamer', 'gaming', 'esports', 'twitch', 'steam', 'xbox', 'playstation', 'nintendo', 'unity', 'unreal', 'console', 'controller', 'joystick'],
                    "Health/Fitness": ['health', 'doctor', 'clinic', 'workout', 'gym', 'pharmacy', 'fitness', 'medical', 'hospital', 'yoga', 'meditation', 'sleep', 'period', 'cycle', 'track', 'calorie', 'step', 'nurse', 'appointment', 'patient', 'lab', 'medicine', 'drug', 'care', 'well', 'heart', 'body', 'mental', 'therapy', 'dental', 'vision', 'diet', 'nutrition', 'weight', 'muscle', 'training', 'pulse', 'bp', 'sugar', 'glucose'],
                    "Education/Learning": ['school', 'university', 'learn', 'course', 'quiz', 'student', 'study', 'education', 'academy', 'tutor', 'exam', 'result', 'portal', 'class', 'teacher', 'lesson', 'skill', 'language', 'read', 'write', 'math', 'science', 'history', 'dictionary', 'vocabulary', 'prep', 'homework', 'lecture', 'degree', 'diploma', 'certificate', 'campus', 'admission', 'library', 'textbook', 'e-learning'],
                    "Government/Public": ['gov', 'passport', 'citizen', 'tax', ' id ', 'vote', 'official', 'public', 'service', 'national', 'ministry', 'police', 'emergency', 'utility', 'bill', 'electric', 'water', 'gas', 'council', 'election', 'permit', 'license', 'registry', 'pension', 'benefit', 'social security', 'aadhaar', 'voter', 'pan', 'gst', 'income tax', 'municipal', 'city', 'state', 'federal', 'official'],
                    "Navigation/Maps": ['map', 'gps', 'navigate', 'direction', 'location', 'radar', 'drive', 'traffic', 'compass', 'street', 'route', 'tracking', 'finder', 'way', 'address', 'postal', 'coordinate', 'earth', 'world', 'transit', 'speed', 'speedo', 'trip', 'odometer', 'navigation', 'lane', 'parking', 'fuel', 'ev'],
